...
exports.Class = Module.Class.extend({
    create: function(spec){
        var
        vehicle = this.require('vehicle').value.attributes,
        ...
        fields.push({label:'Join Date', value:(new Date(vehicle.createdAt)).toLocaleDateString(common.getLang(), common.getDateFormat())})
