...
Object.freeze(G_OBJECT_DESC = {
    ...
    344: 'When dealt damage by hero, cyclop devour a random beast to heal itself',
    ...
    400: 'Whenever dealt damage, gain one health',
    401: 'When reveal, all bats gain drain ability. Whenever dealt damage, gain one health',
    402: 'Whenever dealt damage gain one health and one attack',
    406: 'When reveal loot one coin from hero',
    407: 'Whenever dealt damage plunder one coin from hero',
    408: 'Whenever dealt damage pillage five coins from hero',
    448: 'Immune to ranged attacks',
    449: 'Immune to melee attacks',
    450: 'Immune to both normal ranged and melee attack',
    457: 'Whenever dealt damage the wounded hero lost one will point',
    458: 'Whenever dealt damage the ounded hero lost one attack point',
    459: 'Whenever dealt damage the wounded golem absorb cooldown time from hero to reanimate itself',
    ...
    496: 'Whenever dealt damage, hero can\'t flee for 1 turns',
    497: 'Whenever dealt damage, hero can\t flee for 2 turns',
