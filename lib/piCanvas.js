pico.def('piCanvas', function(){
    ...
    var
    Renderer = function(zOrder){
        this.entities = [];
        this.zOrder = zOrder;
    };

    Renderer.prototype.createCircle = function(){
    };

    Renderer.prototype.showEntity = function(){
    };

    Renderer.prototype.hideEntity = function(){
    };

    Renderer.prototype.updateEntity = function(){
    };
    ...
    Layer.prototype.createRenderer = function(zOrder){
        var r = new Renderer(this.context, zOrder);
        this.rendererList.push(r);
        return r;
    };
