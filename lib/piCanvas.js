pico.def('piCanvas', function(){
    ...
    update = function(){
        var now = Date.now();
        me.signal('piCanvas.beat', [layers, now - lastUpdateTime]);
        lastUpdateTime = now;
    ...
    this.addLayer = function(id, depth, unit){
        ...
        l = new Layer(id, canvas, stage.offsetLeft, stage.offsetTop, stage.offsetWidth, stage.offsetHeight, depth || 100, unit);
