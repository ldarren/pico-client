pico.def('piCanvas', function(){
    ...
    Object.defineProperties(me, {
        FINGER_TWICE: {value:me.moduleName+'.twice', writable:false, configurable:false, enumerable:true},
        FINGER_UP: {value:me.moduleName+'.up', writable:false, configurable:false, enumerable:true},
        FINGER_DOWN: {value:me.moduleName+'.down', writable:false, configurable:false, enumerable:true},
        FINGER_MOVE: {value:me.moduleName+'.move', writable:false, configurable:false, enumerable:true},
        FINGER_OUT: {value:me.moduleName+'.out', writable:false, configurable:false, enumerable:true}});

    var
    signalFingerUp = function(evt){
        me.signal(me.FINGER_UP, evt);
    },
    evtRegulator = function(){
        ...
        if (1 < fingerUp.length){
            // multiple clicks, eat all finger events (including moves) except for outstanding finger down
            ...
            for(var i=0,l=bucket.length; i<l; i++){
                ...
                case me.FINGER_UP:
                    ...
                    setTimeout(signalFingerUp, 20, evt[1]);
                    break;
                case me.FINGER_MOVE:
                    lastMove = evt;
                    break;
    ...
    me.handleEvent = function(evt){
        ...
        case 'mouseup':
            ...
            if (fingerTimerId){
                ...
                setTimeout(signalFingerUp, 20, [evt, evt.clientX, evt.clientY]);
            }
            break;
        case 'mouseout':
            mouseButton = 0;
        ...
        case 'touchcancel':
            ...
            if (fingerTimerId){
                ...
                setTimeout(signalFingerUp, 20, [evt, touch.pageX, touch.pageY, evt.touches.length]);
            }
            break;
        case 'touchleave':
            target.removeEventListener('touchmove', me, false);
