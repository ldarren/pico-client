...
module.exports = {
    ...
    init: function(query, width, height){
    ...
    getLayer: function(id){ return layers[id] },
    getStageTop: function(){ return stage.offsetTop },
    getStageLeft: function(){ return stage.offsetLeft },
    getStageWidth: function(){ return stage.offsetWidth },
    getStageHeight:function(){ return stage.offsetHeight },
