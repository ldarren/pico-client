...
pico.def('picUIContent', 'picBase', function(){
    ...
    Object.defineProperty(this, 'CUSTOM_BUTTON', {value:4, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'CUSTOM_DROP', {value:5, writable:false, configurable:false, enumerable:true});
...
//ctx.stroke();
    ...
    doPicking = function(focus, uiRect, ui, x, y){
        ...
        if (ui[MESH_DRAG]){
            ...
            ui[MESH_TYPE] = TYPE_HIDE;
console.log('doPicking: '+focus[FOCUS_DRAG_UI].userData.id+' focus:'+focus[FOCUS_DRAG_UI][MESH_TYPE]);
            return true;
        }
        return false;
    },
        ...
        return walkMeshUI.call(this, rect, meshUI, function(type){
            ...
            case WALK_UI:
                ...
                case TYPE_CUSTOM:
                    uiRect = cb.call(this, me.CUSTOM_BOUND, cellRect, ui, scale);
                    if (x > uiRect[0] && x < uiRect[0]+uiRect[2] && y > uiRect[1] && y < uiRect[1]+uiRect[3]){
                        ret = doPicking(focus, uiRect, ui, x, y);
console.log('pickMeshUI: '+focus[FOCUS_DRAG_UI].userData.id+' focus:'+focus[FOCUS_DRAG_UI][MESH_TYPE]);
                    }
                    break;
                }
                break;
...
console.log('dragMeshUI: '+focus[FOCUS_DRAG_UI].userData.id+' focus:'+focus[FOCUS_DRAG_UI][MESH_TYPE]);
            return true;
        }
        return false;
    },
...
console.log('dropMeshUI: '+focus[FOCUS_DRAG_UI].userData.id+' focus:'+focus[FOCUS_DRAG_UI][MESH_TYPE]);
                    ui = focus[FOCUS_DRAG_UI];
                    focus[FOCUS_DRAG_UI] = null;
                    ...
                    if (ui && cell[0][MESH_DROP]){
                        cb.call(this, CUSTOM_DROP, ui, cell);
                    }
                    ret = true;
                }
                break;
