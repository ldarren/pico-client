...
//ctx.stroke();
    ...
    me.drawButton = function(ctx, ts, label, rect, scale, fontColor, faceColor, borderColor, baseline){
        ctx.fillStyle = faceColor;
        ctx.strokeStyle = borderColor || faceColor;
        ctx.fillRect.apply(ctx, rect);
        ctx.strokeRect.apply(ctx, rect);
        ctx.fillStyle = fontColor;
        me.fillIconText(ctx, ts, label, rect, scale, {align: 'center', baseline: baseline || 'middle'});
    };
