...
pico.def('picUIContent', 'picBase', function(){
    ...
    FOCUS_BTN_UI=0,FOCUS_BTN_STATE=1,FOCUS_DRAG_UI=2,FOCUS_DRAG_X=3,FOCUS_DRAG_Y=4,
    templates = {},
    ...
    walkMeshUI = function(rect, meshUI, cb){
        ...
        if (ret = cb.call(this, WALK_REGION_START, rows[0])) return ret;
        ...
        for(r=1; r<rl; r++){
            ...
            if (ret = cb.call(this, WALK_ROW_START, row[0])) return ret;
            ...
            for(c=1; c<cl; c++){
                ...
                if (ret = cb.call(this, WALK_CELL_START, cell[0])) return ret;
                ...
                if (ret = cb.call(this, WALK_CELL_END, cell[0])) return ret;
            }
            if (ret = cb.call(this, WALK_ROW_END, row[0])) return ret;
        }
        if (ret = cb.call(this, WALK_REGION_END, rows[0])) return ret;
    },
...
//ctx.stroke();
        ...
        if (focus[FOCUS_BTN_CELL]){
            uiRect = cb.call(this, me.CUSTOM_BOUND, cellRect, ui, tileScale);
            cb.call(this, me.CUSTOM_BUTTON, ctx, uiRect, ui, tileSets[ui.tileSet || DEFAULT], tileScale);
        }
        if (focus[FOCUS_DRAG_CELL]){
            uiRect = cb.call(this, me.CUSTOM_BOUND, cellRect, ui, tileScale);
            cb.call(this, me.CUSTOM_DRAG, ctx, uiRect, ui, tileSets[ui.tileSet || DEFAULT], tileScale);
        }
    },
    handleButtonUp = function(focus, ui){
    },
    handleButtonDown = function(focus, ui){
    },
    handlePicking = function(focus, ui){
    },
    handleDropping = function(focus, ui){
    },
                ...
                case TYPE_CUSTOM:
                    if (ui[MESH_BUTTON]){
                        ...
                        if (x > uiRect[0] && x < uiRect[0]+uiRect[2] && y > uiRect[1] && y < uiRect[1]+uiRect[3]){
                            ...
                            ui[MESH_BUTTON] = ret ? BTN_DOWN : BTN_UP;
                        }else{
    ...
    pickMeshUI = function(com, x, y, rect, meshUI, tileScale, cb){
        if 
        var
        ret = false,
        cellRect, ui;
