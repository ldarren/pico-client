...
pico.def('picUIContent', 'picBase', function(){
    ...
    Object.defineProperty(this, 'TOP_LEFT',   {value:3, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'TOP',        {value:1, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'TOP_RIGHT',  {value:5, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'LEFT',       {value:2, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'CENTER',     {value:16, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'RIGHT',      {value:4, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'BOTTOM_LEFT',{value:10, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'BOTTOM',     {value:8, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'BOTTOM_RIGHT',{value:12, writable:false, configurable:false, enumerable:true});

    Object.defineProperty(this, 'CUSTOM_BOUND', {value:1, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'CUSTOM_DRAW',  {value:2, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'CUSTOM_CLICK', {value:3, writable:false, configurable:false, enumerable:true});
    ...
    MESH_CELL='cell',MESH_TYPE='type',MESH_CELL_PT='cellPt',MESH_UI_PT='uiPt',MESH_PAD='pad',MESH_W='w',MESH_H='h',MESH_ROWS='rows',
    MESH_BUTTON='button',MESH_DRAGDROP='dragdrop',DEFAULT='default',
    FOCUS_BTN_UI=0,FOCUS_BTN_CELL=1,FOCUS_DRAG_UI=2,FOCUS_DRAG_CELL=3,FOCUS_DRAG_X=4,FOCUS_DRAG_Y=5,
    templates = {},
    ...
    walkMeshUI = function(rect, meshUI, cb){
        ...
        if (ret = cb.call(this, WALK_REGION_START, rows)) return ret;
        ...
        for(r=1; r<rl; r++){
            ...
            for(c=1; c<cl; c++){
                ...
                if (ret = cb.call(this, WALK_CELL_START, cell)) return ret;
                ...
                for(u=1; u<ul; u++){
                    ...
                    case TYPE_MESH:
                        ...
                        break;
                    default:
                        if (ret = cb.call(this, WALK_UI, cellRect, ui)) return ret;
                        break;
                    }
                }
        ...
        if (ret = cb.call(this, WALK_REGION_END, rows)) return ret;
    },
    ...
    drawMeshUI = function(ctx, focus, rect, meshUI, tileSets, tileScale, font, cb){
        var opt, cellRect, ui;
...
//ctx.strokeStyle = 'red';
                    uiRect = calcUIRect(cellRect, ui);
                    drawMeshText.call(this, ctx, uiRect, ui, tileSets[ui.tileSet || DEFAULT], tileScale);
                    break;
                case TYPE_TILE:
//ctx.fillStyle = 'white';
//ctx.strokeStyle = 'white';
                    uiRect = calcUIRect(cellRect, ui, tileScale);
                    drawMeshTile.call(this, ctx, uiRect, ui, tileSets[ui.tileSet || DEFAULT], tileScale);
                    break;
                case TYPE_CUSTOM:
//ctx.fillStyle = 'blue';
//ctx.strokeStyle = 'blue';
                    uiRect = cb.call(this, me.CUSTOM_BOUND, cellRect, ui, tileScale);
                    cb.call(this, me.CUSTOM_DRAW, ctx, uiRect, ui, tileSets[ui.tileSet || DEFAULT], tileScale);
                    break;
                }
...
//ctx.stroke();
        ...
        cellRect = focus[FOCUS_BTN_CELL];
        if (ui){
            uiRect = cb.call(this, me.CUSTOM_BOUND, cellRect, ui, tileScale);
            cb.call(this, me.CUSTOM_BUTTON, ctx, uiRect, ui, tileSets[ui.tileSet || DEFAULT], tileScale);
        }
        ui = focus[FOCUS_DRAG_UI];
        cellRect = focus[FOCUS_DRAG_CELL];
        if (ui){
            uiRect = cb.call(this, me.CUSTOM_BOUND, cellRect, ui, tileScale);
            cb.call(this, me.CUSTOM_DRAG, ctx, uiRect, ui, tileSets[ui.tileSet || DEFAULT], tileScale);
        }
    },
    doButtonDown = function(focus, cell, uiRect, ui, x, y){
        var
        ret = false,
        oldUI = focus[FOCUS_BTN_UI];
        if (oldUI) oldUI.type = TYPE_CUSTOM;
        oldUI = focus[FOCUS_DRAG_UI];
        if (oldUI) oldUI.type = TYPE_CUSTOM;
    ...
    doButtonUp = function(focus, targetCell, uiRect, ui, x, y){
        var
        btnUI = focus[FOCUS_BTN_UI];
        sourceUI = focus[FOCUS_DRAG_UI],
        sourceCell, sourceIdx, targetIdx;

        if (btnUI) targetUI.type = TYPE_CUSTOM;
        if (sourceUI) sourceUI.type = TYPE_CUSTOM;
        ...
        if (sourceUI && targetCell[0][MESH_DRAGDROP]){
            sourceCell = sourceUI.cell;
            sourceIdx = sourceCell.indexOf(sourceUI);
            sourceCell.splice(sourceIdx, 1);
            if (ui && ui[MESH_DRAGDROP]){
                targetIdx = targetCell.indexOf(targetUI)
                targetCell.splice(targetIdx, 1);
                targetCell.splice(targetIdx, sourceUI);
                sourceCell.splice(sourceIdx, 0, targetUI);
            }else{
                targetCell.push(sourceUI);
            }
            return true;
        }
        return false;
    },
    doPicking = function(focus, cell, uiRect, ui, x, y){
        var
        ret = false,
        oldUI = focus[FOCUS_BTN_UI];
        if (oldUI) oldUI.type = TYPE_CUSTOM;
    ...
    doDropping = function(focus, targetCell, uiRect, ui, x, y){
        var
        btnUI = focus[FOCUS_BTN_UI];
        sourceUI = focus[FOCUS_DRAG_UI],
        sourceCell, sourceIdx, targetIdx;
    ...
    clickMeshUI = function(focus, x, y, state, rect, meshUI, tileScale, cb){
        var
        ret = false,
        cell, cellRect, uiRect, ui;
            ...
            case WALK_UI:
                ...
                case TYPE_CUSTOM:
                    ...
                    if (x > uiRect[0] && x < uiRect[0]+uiRect[2] && y > uiRect[1] && y < uiRect[1]+uiRect[3]){
                        if (state) doButtonDown(focus, uiRect, ui, x, y);
                        else doButtonUp(focus, uiRect, ui, x, y);
                    }
                    break;
                }
                break;
    ...
    pickMeshUI = function(focus, x, y, rect, meshUI, tileScale, cb){
        var
        ret = false,
        cell, cellRect, uiRect, ui;
    ...
    dragMeshUI = function(focus, x, y, rect, meshUI, tileScale, cb){
        var
    ...
    dropMeshUI = function(focus, x, y, rect, meshUI, tileScale, cb){
        var
        ret = false,
        cell, cellRect, uiRect, ui;
        ...
        return walkMeshUI.call(this, rect, meshUI, function(type){
            ...
            case WALK_UI:
                ...
                case TYPE_CUSTOM:
                    uiRect = cb.call(this, me.CUSTOM_BOUND, cellRect, ui, tileScale);
                    if (x > uiRect[0] && x < uiRect[0]+uiRect[2] && y > uiRect[1] && y < uiRect[1]+uiRect[3]){
                        doDropping(focus, uiRect, ui, x, y);
                    }
                    break;
                }
                break;
    ...
    populateMeshUI = function(template, ui){
        ...
        if (!ui[MESH_BUTTON]) ui[MESH_BUTTON] = 0;
        if (!ui[MESH_DRAGDROP]) ui[MESH_DRAGDROP] = 0;
    },
            ...
            for(r=1; r<rl; r++){
                ...
                for(c=1; c<cl; c++){
                    ...
                    for(n=0,nl=nodes.length; n<nl; n++){
                        unodes.push(copyMeshUI({cell:unodes}, nodes[n], cwidth, rheight));
                    }
                }
            }
            break;
    ...
    me.createMeshCustom = function(cell, cellPt, uiPt, pad, width, height, button, dragdrop, userData){
        var ui = {
            type: TYPE_CUSTOM,
            cell:cell,
            cellPt: cellPt,
    ...
    me.drawMeshUI = function(ctx, rect, meshUI, tileSets, tileScale, font, cb){
        //always start from 0,0 not rect.x, rect.y. it will be offset in uiWindow
        drawMeshUI.call(this, ctx, [0, 0, rect.width, rect.height], meshUI, tileSets, tileScale, font, cb);
    };

    me.clickMeshUI = function(x, y, state, rect, meshUI, scale, cb){
        //always start from 0,0 not rect.x, rect.y. it will be offset in uiWindow
        return clickMeshUI.call(this, x, y, state, [0, 0, rect.width, rect.height], meshUI, scale, cb);
    };

    me.pickMeshUI = function(focus, x, y, rect, meshUI, scale, cb){
        return pickMeshUI.call(this, x, y, [0, 0, rect.width, rect.height], meshUI, scale, cb);
    };

    me.dragMeshUI = function(focus, x, y, rect, meshUI, scale, cb){
        return dragMeshUI.call(this, x, y, [0, 0, rect.width, rect.height], meshUI, scale, cb);
    };

    me.dropMeshUI = function(focus, x, y, rect, meshUI, scale, cb){
        return dropMeshUI.call(this, x, y, [0, 0, rect.width, rect.height], meshUI, scale, cb);
    };
