...
pico.def('picUIContent', 'picBase', function(){
    ...
    MESH_BTN='button',MESH_DRAGDROP='dragdrop',DEFAULT='default',
    ...
    drawMeshUI = function(ctx, tileSets, rect, meshUI, focus, font, scale, cb){
        var opt, cellRect, ui;
...
//ctx.strokeStyle = 'red';
                    uiRect = calcUIRect(cellRect, ui);
                    drawMeshText.call(this, ctx, uiRect, ui, tileSets[ui.tileSet || DEFAULT], scale);
                    break;
                case TYPE_TILE:
//ctx.fillStyle = 'white';
//ctx.strokeStyle = 'white';
                    uiRect = calcUIRect(cellRect, ui, scale);
                    drawMeshTile.call(this, ctx, uiRect, ui, tileSets[ui.tileSet || DEFAULT], scale);
                    break;
                case TYPE_CUSTOM:
//ctx.fillStyle = 'blue';
//ctx.strokeStyle = 'blue';
                    uiRect = cb.call(this, me.CUSTOM_BOUND, cellRect, ui, scale);
                    cb.call(this, me.CUSTOM_DRAW, ctx, uiRect, ui, tileSets[ui.tileSet || DEFAULT], scale);
                    break;
                }
...
//ctx.stroke();
        ...
        if (ui){
            uiRect = cb.call(this, me.CUSTOM_BOUND, cellRect, ui, scale);
            cb.call(this, me.CUSTOM_BUTTON, ctx, uiRect, ui, tileSets[ui.tileSet || DEFAULT], scale);
        }
        ...
        if (ui){
            ...
            cb.call(
                ...
                me.CUSTOM_DRAG,
                ctx,
                [focus[FOCUS_DRAG_X], focus[FOCUS_DRAG_Y], uiRect[1], uiRect[2]],
                ui,
                tileSets[ui.tileSet || DEFAULT],
                scale);
        }
    },
    ...
    clickMeshUI = function(x, y, state, rect, meshUI, focus, scale, cb){
        var
        ret = false,
    ...
    pickMeshUI = function(x, y, rect, meshUI, focus, scale, cb){
        var
        ret = false,
        cell, cellRect, uiRect, ui;
    ...
    dragMeshUI = function(x, y, rect, meshUI, focus, scale, cb){
        var
    ...
    dropMeshUI = function(x, y, rect, meshUI, focus, scale, cb){
        var
        ret = false,
        cell, cellRect, uiRect, ui;
    ...
    me.drawMeshUI = function(ctx, tileSets, com, comBox, scale, cb){
        //always start from 0,0 not rect.x, rect.y. it will be offset in uiWindow
        drawMeshUI.call(this, ctx, tileSets, [0, 0, comBox.width, comBox.height], com.layout, com.focus, com.font, scale, cb);
    };

    me.clickMeshUI = function(x, y, state, com, comBox, scale, cb){
        //always start from 0,0 not comBox.x, comBox.y. it will be offset in uiWindow
        return clickMeshUI.call(this, x, y, state, [0, 0, comBox.width, comBox.height], com.layout, com.focus, scale, cb);
    };

    me.pickMeshUI = function(x, y, com, comBox, scale, cb){
        return pickMeshUI.call(this, x, y, [0, 0, comBox.width, comBox.height], com.layout, com.focus, scale, cb);
    };

    me.dragMeshUI = function(x, y, com, comBox, scale, cb){
        return dragMeshUI.call(this, x, y, [0, 0, comBox.width, comBox.height], com.layout, com.focus, scale, cb);
    };

    me.dropMeshUI = function(x, y, com, comBox, scale, cb){
        return dropMeshUI.call(this, x, y, [0, 0, comBox.width, comBox.height], com.layout, com.focus, scale, cb);
    };
