...
pico.def('picUIContent', 'picBase', function(){
    ...
    drawMeshText = function(ctx, rect, meshText, ts, tileScale){
        ...
        me.fillIconText(ctx, ts, meshText.text, rect, tileScale, {align:align,baseline:baseline});
    },
...
//ctx.beginPath();
                ...
                case TYPE_HIDE:
                    if (ui === focus[FOCUS_BTN_UI]){
                        ...
                        cb.call(this, me.CUSTOM_BUTTON, ent, ctx, uiRect, ui, tileSets[ui.tileSet || DEFAULT], scale);
                    }else if (ui === focus[FOCUS_DRAG_UI]){
...
//ctx.strokeStyle = 'blue';
                    ...
                    cb.call(this, me.CUSTOM_DRAW, ent, ctx, uiRect, ui, tileSets[ui.tileSet || DEFAULT], scale);
                    break;
                }
...
//ctx.stroke();
    ...
    me.clickMeshUI = function(x, y, state, ent, com, comBox, scale, cb){
        ...
        if (!ret) cb.call(this, me.CUSTOM_CLICK, ent, null); // click on window, some app might need to handle that
        return ret;
    };
    ...
    me.fillIconText = function(ctx, ts, text, rect, scale, options){
        var
        align = 2,
        baseline = 2,
        padX = 0, padY = 0,
    ...
    me.drawButton = function(ctx, rect, label, fontColor, faceColor, borderColor, baseline){
        ...
        ctx.fillText(label, rect[0]+rect[2]/2, rect[1]+rect[3]/2, rect[2]);
    };
