...
pico.def('picUIContent', 'picBase', function(){
    ...
    Object.defineProperty(this, 'TYPE_TEXT',      {value:1, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'TYPE_TILE',      {value:2, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'TYPE_CUSTOM',    {value:4, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'TYPE_MESH',    {value:5, writable:false, configurable:false, enumerable:true});
    ...
    Object.defineProperty(this, 'WALK_REGION_START', {value:1, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'WALK_REGION_END', {value:2, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'WALK_ROW_START', {value:3, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'WALK_ROW_END', {value:4, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'WALK_CELL_START', {value:5, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'WALK_CELL_END', {value:6, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'WALK_UI', {value:7, writable:false, configurable:false, enumerable:true});
    ...
    walkMeshUI = function(rect, meshUI, cb){
        ...
        if (cb(me.WALK_REGION_START, rows[0])) return;
        ...
        for(r=1; r<rl; r++){
            ...
            if (cb(me.WALK_ROW_START, row[0])) return;
            ...
            for(c=1; c<cl; c++){
                ...
                if (cb(me.WALK_CELL_START, cell[0])) return;
                ...
                for(u=1; u<ul; u++){
                    ...
                    case me.TYPE_MESH:
                        ...
                        ret = walkMeshUI.call(this, uiRect, ui);
                        break;
                    default:
                        cb(me.WALK_UI, ui);
                        break;
                ...
                if (cb(me.WALK_CELL_END, cell[0])) return;
            }
            if (cb(me.WALK_ROW_END, row[0])) return;
        }
        if (cb(me.WALK_REGION_END, rows[0])) return;
    },
    drawMeshUI = function(ctx, rect, meshUI, tileSets, tileScale, font, cb){
        var opt, uiRect, ui;
        walkMeshUI(rect, meshUI, function(type){
            switch(type){
            case me.WALK_REGION_START:
                opt = arguments[1];
                ...
                setOption(ctx, opt);
                break;
            case me.WALK_REGION_END:
                ctx.restore();
                break;
            case me.WALK_ROW_START:
                opt = arguments[1];
                ctx.save();
                setOption(ctx, opt);
                break;
            case me.WALK_ROW_END:
                ctx.restore();
                break;
            case me.WALK_CELL_START:
                opt = arguments[1];
                ctx.save();
                setOption(ctx, opt);
...
//ctx.strokeStyle = 'blue';
                    ...
                    case me.TYPE_MESH:
                        uiRect = calcUIRect(cellRect, ui);
                        drawMeshUI.call(this, ctx, uiRect, ui, tileSets, tileScale, font);
                        break;
                    }
//ctx.arc(uiRect[0], uiRect[1], 2, 0, 2 * Math.PI, false);
//ctx.fill();
...
//ctx.stroke();
    ...
    clickMeshUI = function(x, y, state, rect, meshUI, tileScale, cb){
        var
        inner = calcUIRect(rect, meshUI),
        rows = meshUI.rows,
        region = [],
        ...
        for(r=1; r<rl; r++){
            ...
            if (cl < 2) continue;
            w = inner[2]/(cl-1);
            region[1] = inner[1]+h*(r-1), region[2] = w, region[3] = h;
            for(c=1; c<cl; c++){
                cell = row[c];
                region[0] = inner[0]+w*(c-1);
                for(u=1,ul=cell.length; u<ul; u++){
                    ui = cell[u];
                    switch(ui.type){
                    case me.TYPE_CUSTOM:
                        if (ui[MESH_BUTTON]){
                            uiRect = cb.call(this, me.CUSTOM_BOUND, region, ui, tileScale);
                            if (x > uiRect[0] && x < uiRect[0]+uiRect[2] && y > uiRect[1] && y < uiRect[1]+uiRect[3]){
                                if (!state && BTN_DOWN === ui[MESH_BUTTON]) ret = cb.call(this, me.CUSTOM_CLICK, ui);
                                ui[MESH_BUTTON] = state ? BTN_DOWN : BTN_UP;
                            }else{
                                ui[MESH_BUTTON] = BTN_UP;
                            }
                        }
                        break;
                    case me.TYPE_MESH:
                        uiRect = calcUIRect(region, ui);
                        ret = clickMeshUI.call(this, x, y, state, uiRect, ui, tileScale);
                        break;
                    }
                }
            }
    ...
    populateMeshUI = function(template, ui){
        ...
        if (!ui[MESH_DRAGDROP]) ui[MESH_DRAGDROP] = null;
    },
    ...
    me.pickMeshUI = function(x, y, rect, meshUI, scale, cb){
        return false;
    };

    me.dragMeshUI = function(x, y, rect, meshUI, scale, cb){
        return false;
    };

    me.dropMeshUI = function(x, y, rect, meshUI, scale, cb){
        return false;
    };
    ...
    me.pick = function(ent, evt){
        // place holder
        return false;
    };

    me.drag = function(ent, evt){
        // place holder
        return false;
    };

    me.drop = function(ent, evt){
        // place holder
        return false;
    };
