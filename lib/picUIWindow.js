pico.def('picUIWindow', 'picBase', function(){
    ...
    drawBorderCell = function(ctx, rect, cell){
        ...
        for(i=1,l=cell.length; i<l; i++){
            ...
            switch(ui.type){
                case me.TYPE_TEXT:
                    drawBorderText(ctx, [rect[0]+rect[3]*(i-1), rect[1], w, rect[3]], ui);
                    break;
                case me.TYPE_TILE:
                    drawBorderTile(ctx, [rect[0]+rect[3]*(i-1), rect[1], w, rect[3]], ui);
                    break;
                case me.TYPE_BUTTON:
                    drawBorderButton(ctx, [rect[0]+rect[3]*(i-1), rect[1], w, rect[3]], ui);
                    break;
                case me.TYPE_CUSTOM:
                    drawBorderCustom(ctx, [rect[0]+rect[3]*(i-1), rect[1], w, rect[3]], ui);
                    break;
                case me.TYPE_LAYOUT:
                    drawBorderLayout(ctx, [rect[0]+rect[3]*(i-1), rect[1], w, rect[3]], ui);
                    break;
            }
        }
        ctx.restore();
