...
//ctx.strokeStyle = 'blue';
                        uiRect = this.onCalcMeshUICustom(cellRect, ui, tileScale);
                        this.onDrawMeshUICustom(ctx, uiRect, ui, tileSets[ui.tileSet || DEFAULT], tileScale);
                        break;
                    case me.TYPE_MESH:
                        uiRect = calcUIRect(cellRect, ui);
...
//ctx.stroke();
    ...
    clickMeshUI = function(x, y, state, rect, meshUI, tileScale){
        var
        inner = calcUIRect(rect, meshUI),
        rows = meshUI.rows,
        region = [],
    ...
    me.clickMeshUI = function(x, y, state, rect, meshUI, scale){
        //always start from 0,0 not rect.x, rect.y. it will be offset in uiWindow
        return clickMeshUI.call(this, x, y, state, [0, 0, rect.width, rect.height], meshUI, scale);
    };

    me.dragMeshUI = function(){
    };

    me.dropMeshUI = function(){
    };
