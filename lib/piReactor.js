...
pico.def('picGroup', function(){
    ...
    Entity.prototype.attach = function(component, data){
        data = component.create.call(me, this, data);
        data.host = component;
        this.components[component.moduleName] = data;
    };

    Entity.prototype.detach = function(component){
        var data = this.getComponent(component.moduleName);
        if (!data) return;
        component.destroy.call(me, this, data);
    ...
    Entity.prototype.detachAll = function(){
        ...
        for(var i=0, l=keys.length; i<l; i++){
            ...
            component.destroy.call(me, this, this.getComponent(name));
        }
        this.components = {};
    };
