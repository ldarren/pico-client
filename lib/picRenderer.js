pico.def('picRenderer', 'picBase', function(){
    ...
    me.registerContext = function(id, context, zOrder, rect){
        ...
        drawComponents[id] = [];
        drawEntities[id] = [];
        contexts[id] = {context:context, zOrder:zOrder, rect:rect || [0,0,0,0], alpha:1, clear:context.clearRect, bg:'transparent', isDirty: false};
    };
    ...
    me.draw = function(elapsed, evt, entities){
        ...
        for(i=0, l=contextOrder.length; i<l; i++){
            ...
            for(c=0; c<cl; c++){
                ...
                o = dComs[c];
                mod = pico.getModule(o);
console.log('picRenderer draw: '+e.name);
