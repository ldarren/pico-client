...
module.exports = {
    ...
    isTouching: function(here, there){
        var w = me.mapWidth;
    ...
    getNeighbours: function(at, isOpen, neighbours){
        var
        w = me.mapWidth,
        pos;
    ...
    getNeighbour: function(at, toward, isOpen, heuristic){
        var
        width = this.mapWidth,
        bestPos = at,
    ...
    aStar: function(from, to, isOpen, getNeighbours, heuristic){
        var
        costG = me.costG,
        costF = me.costF,
