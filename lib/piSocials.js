pico.def('piSocials', function(){
    ...
    me.fbAppToken = function(secret, cb){
        ...
        pico.ajax('get', 'https://graph.facebook.com/oauth/access_token',
        {
            client_id: fbAppId,
    ...
    me.fbFriends = function(limit, cb){
        ...
        getFBRecurse('/me/friends?fields=id,first_name,installed&limit=100', fbFriends, limit, cb);
    };
    ...
    me.fbCreateAchievement = function(url, cb){
        cb = cb || dummyCB;
        pico.ajax('post', GRAPH_DOMAIN+'/'+fbAppId+'/achievements', 
    ...
    me.fbReadAchievements = function(cb){
        FB.api('/'+fbAppId+'/achievements', 'GET', {access_token: fbAppToken}, cb || dummyCB);
    };
    ...
    me.fbDeleteAchievement = function(url, cb){
        FB.api('/'+fbAppId+'/achievements', 'DELETE', {achievement:url, access_token:fbAppToken}, cb || dummyCB);
    };
});
