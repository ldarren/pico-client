...
pico.def('piHexGameMap', function(){
    Object.defineProperty(this, 'N', {value:32, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'NE', {value:16, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'SE', {value:8, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'S', {value:4, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'SW', {value:2, writable:false, configurable:false, enumerable:true});
    Object.defineProperty(this, 'NW', {value:1, writable:false, configurable:false, enumerable:true});

    Object.defineProperty(this, 'UPDATE', {value:'update', writable:false, configurable:false, enumerable:true});
    ...
    this.create = function(name, screen, tile, col, row){
        return new HexGameMap(name, screen, tile, col, row);
    };

    this.load = function(screen, obj){
