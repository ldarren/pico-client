...
pico.def('piHTMLAudio', function(){
    ...
    AudioSprite.prototype = {
        ...
        play: function(index){
            ...
            var tile = audio.sprite.list[index];
        ...
        playList: function(indices, minGap, maxGap, ordered){
            var duration = 0;
            window.setTimeout(function(){
            }, duration + minGap + Math.floor(Math.random()*(maxGap-minGap)));
        },
