...
console.log('audioSprite muted, readyState, currentTime', muted, audio.readyState, audio.currentTime);
            //if (4 === audio.readyState) {
                audio.currentTileId = index;
                pauseAll();
                audio.currentTime = tile[0]; // for immediate sound effect
console.log('audioSprite volume, currentTileId, currenntTime', audio.volume, audio.currentTileId, audio.currentTime);
                audio.play();
            //}
            return tile;
        },
