...
changeRoute = function(evt, paths, params){
    ...
    pages=this.pages,
    pc=this.paneCount || 1,
    i=Max(paths.length-pc,0) // if pages more than panes, ignore front paths

    for(var j=0,p; j<pc; i++,j++){
        p=paths[i] || ''
        this.signals.paneUpdate(j, p, pages[p], params).send()
    }
...
Frame.prototype={
    ...
    create: function(deps, params){
        var self=this
		View.prototype.create.call(this, deps, params, function(){
